...
---
<!--
Do not edit this file - Generated from https://github.com/tangibleinc/update-server
-->
# Update Server

A custom update API for WordPress plugins and themes, based on [WP Update Server](https://github.com/YahnisElsts/wp-update-server/).

Source: https://github.com/tangibleinc/update-server

There is a correspoding [Tangible Updater module](https://github.com/tangibleinc/updater).

## Deploy

Copy example Docker Compose config.

```sh
cp docker-compose.example.yml docker-compose.yml
```

The newly created file is meant for local customization and production use, excluded from the Git repository.

- `docker-compose.yml` - Docker container definitions; change server port as needed

## Permissions

You might need to change permissions to allow Docker process to write to `logs` and `cache` folders.
...
Original documentation included below.
